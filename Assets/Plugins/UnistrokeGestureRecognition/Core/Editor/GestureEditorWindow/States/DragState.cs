...
namespace UnistrokeGestureRecognition.Editors.Window {
    sealed class DragState : EditorState {
        ...
        public override void Enter() {
            Editor.ChangeDragLabelVisibility(true);
            Editor.ChangeDragHintsVisibility(true);
        ...
        public override void Exit() {
            Editor.ChangeDragLabelVisibility(false);
            Editor.ChangeDragHintsVisibility(false);
