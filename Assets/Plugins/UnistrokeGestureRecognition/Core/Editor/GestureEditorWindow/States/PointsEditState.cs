...
namespace UnistrokeGestureRecognition.Editors.Window {
    sealed class PointsEditState : EditorState {
        ...
        public override void Enter() {
            Editor.ChangeEditLabelVisibility(true);
            Editor.ChangeEditHintsVisibility(true);
        ...
        public override void Exit() {
            Editor.ChangeEditLabelVisibility(false);
            Editor.ChangeEditHintsVisibility(false);
